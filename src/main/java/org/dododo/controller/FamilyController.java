...
import org.dododo.model.DO.ExcelDO;
...
public class FamilyController {
    ...
    public ResultVO<?> deleteFamilyMember(@RequestBody String name) {
        try {
...
//        ExcelDO.parseExcel("D:/programing/jave-basics/data/eating.xls");
